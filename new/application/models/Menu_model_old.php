              ...
              //  if($cat->category_id == 2){
               ...
               // }else{
                ...
                if ($cat->category_id == 0) {
                    ...
                    if($cat->as_menu == 1) {
                        if($cat->options){
                        $link = '<li class=" dropdown-submenu nav-item"><a data-alias="'.$cat->alias.'" class="dropdown-item dropdown-toggle1 '.$no_link.' '.$nav_link.'" href="'.$link1.'">'.@$title[LANG].$icon_menu.'</a>';
                         }elseif($cat->option_2){
                        $link = '<li class=" dropdown-submenu nav-item"><a data-alias="'.$cat->option_2.'" class="dropdown-item dropdown-toggle1 '.$no_link.' '.$nav_link.'" href="'.$link1.'">'.@$title[LANG].$icon_menu.'</a>';
                        } else {
                          $link = '<li class="dropdown-submenu nav-item"><a data-alias="'.$cat->alias.'" class="dropdown-item dropdown-toggle1 '.$no_link.' '.$nav_link.'" href="'.$link1.'">'.@$title[LANG].$icon_menu.'</a>';
                        }
                    } else {
                ...
                $icon_menu1 = ($sub) ? '<i class="fa fa-chevron-right" aria-hidden="true"></i>' : '' ;
