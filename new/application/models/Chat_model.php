...
class Chat_model extends CI_Model 
{
    ...
    public function create($first_id, $second_id)
    {
        ...
        $data['from_user_id'] = $first_id;
        $data['to_user_id'] = $second_id;
    ...
    public function get_chats_messages($chat_id, $last_chat_message_id = 0)
    {
        ...
        $result = $this->db->query($query, array($chat_id, $last_chat_message_id));
    ...
    {
        return $this->db->get_where('chats', array('id' => $id));
    }
    ...
    public function get()
    {
        ...
        $this->db->where('chats.user_id = users.user_id');
        return $this->db->get();
    }

    public function obtain($topic)
    {
        return $this->db->get_where('chats', array('topic' => $topic));
    }
