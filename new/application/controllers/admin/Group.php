...
Class Group extends Admin_Controller
{
    ...
    $config['base_url'] = base_url().'/admin/group/index/'.$group.'/'.$param.'/?';
        ...
        email_respondent('info', $item->email, $subject, $body);
              ...
              // var_dump($newsletter);
				...
				if($this->input->post('meta'))
				{
                 ...
                 if($page){           
                   go_to("admin/group/index/$group/$category_id/?&page=$page");
                    } else{
                        go_to("admin/group/index/$group/$category_id");
                    }
			}			
      ...
      $this->data['media_files'] = $this->posts->get_media_files($id);
       $this->data['media_files_poster'] = $this->posts->get_media_files_poster($id);
		...
		else
		{
			...
			go_to("admin/group/save/$group/$category_id/$new_post_id");
		}
