                ...
                <div class="col-lg-9 col-md-8">
                    <div class="content" id="newsPrint" data-aos="fade-up">
                        ...
                        <div class="content-body">
                             ...
                             <h4><?=lang('search_filter_title')?></h4>
                            <form action="" method="GET">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group vi-nopart">                                      
                                            <select id="region_id" name="region_id" class="form-control vi-nopart">
                                                <option class="vi-nopart" value=""><?=lang('region_filter')?></option>
                                     ...
                                     <div class="col-md-12">
                                        <div class="form-group vi-nopart">
                                            ...
                                            <select id="category_id" name="category_id" class="form-control vi-nopart">
                                                <option class="vi-nopart" value=""><?=lang('institution_filter')?> (<?=lang('area_filter')?>)</option>
                                                <? foreach($notarius_list as $item): ?>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <a href="<?=site_url('notarius')?>" class="btn btn-primary"><?=lang('otmena_f')?></a>
                                        <?php }?>
                                    </div>
                                </div>
                            </form>
