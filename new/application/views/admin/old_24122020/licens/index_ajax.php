...
">Сохранить</button>          
 ...
 <td>
            <?php if($post->spec == 'active'){?>
            <a href="<?= site_url('admin/pages/index/list/'.$post->id) ?>" class="btn btn-info">Список</a>
            <?php }?>
            </td>
          <?php if(_t($post->title, 'uz')){
            ...
            $page = $_GET['page'];            
        ?>  	
                <a href="<?=site_url("admin/pages/save/$category_group/$category_id/$post->id/$page")?>" class="btn btn-small btn-info"><i class="icon-edit icon-white"></i> Ред-ть</a>
                
                <?php } else {?>
           <a href="<?=site_url("admin/pages/save/$category_group/$category_id/$post->id")?>" class="btn btn-small btn-info"><i class="icon-edit icon-white"></i> Ред-ть</a>
        <?php }?>
              </div>
            </td>
