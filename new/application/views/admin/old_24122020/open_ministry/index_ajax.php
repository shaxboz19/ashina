...
">Сохранить</button>          
              ...
              <td>
            <a href="<?= site_url('admin/pages/index/open_ministry_news/'.$post->id) ?>" class="btn btn-info">Новости</a>
            </td>
            <td>
            <a href="<?= site_url('admin/pages/index/open_ministry_category/'.$post->id) ?>" class="btn btn-info">Под категория</a>
            </td>
            </td>
