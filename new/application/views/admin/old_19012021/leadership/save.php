    ...
    <div class="control-group">
		...
		<div class="controls">
			<select name="option" class="input-xlarge focused">
                <option value="yes" <?php echo @$post->option == 'yes'?'selected="selected"':'';?>>Наблюдательный совет</option>
                <option value="no" <?php echo @$post->option == 'no'?'selected="selected"':'';?>> Должностное лицо </option>
            </select>
		</div>
    </div>
    <?php 
