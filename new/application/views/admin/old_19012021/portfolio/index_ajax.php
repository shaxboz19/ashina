...
">Сохранить</button>          
            ...
            <td>
                <a href="<?= site_url('admin/pages/index/portfolio_category/'.$post->id) ?>" class="btn btn-primary">Категории</a>
            </td>
			<td>
                <a href="<?= site_url('admin/pages/index/portfolio_docs/'.$post->id) ?>" class="btn btn-primary">Корп. инф. док.</a>
                
            </td>
            <td>
            <a href="<?= site_url('admin/pages/index/portfolio_docs2/'.$post->id) ?>" class="btn btn-primary">Фин. инф. док.</a>
            </td>
