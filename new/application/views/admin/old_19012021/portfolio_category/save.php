<?=form_open_multipart('', array('class'=>'form-horizontal my_form'))?>
    ...
    <div class="control-group">
         <label class="control-label" for="focusedInput"><?//=lang('status')?>Тип графика</label>
         <div class="controls">
            <select name="value_1" class="input-xlarge focused" required>
                <option value="bar" <?php echo @$post->value_1 == 'bar'?'selected="selected"':'';?>> bar </option>
                <option value="line" <?php echo @$post->value_1 == 'line'?'selected="selected"':'';?>>line</option>
