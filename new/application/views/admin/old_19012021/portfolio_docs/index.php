<h2>  
<p style="font-size:16px;font-weignt:normal"><?=_t($category_o['title'], 'ru');?> (Корпоративная информация документы)</p>
...
<a href="<?=site_url('admin/posts/index/portfolio')?>">Назад</a>
