<h2>  
<p style="font-size:16px;font-weignt:normal"><?=_t($category_o['title'], 'ru');?> (Год)</p>
...
<a href="<?=base_url('admin/pages/index/portfolio_category/'.$category_o['category_id'])?>">Назад</a>
