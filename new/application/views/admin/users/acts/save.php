...
<div class="control-group">
		...
		<div class="controls">
			<input id="date" name="date_creation" class="validate[required] input-xlarge focused" type="text" value="<?=set_value('date_creation', $post->date_creation)?>">
		</div>
	</div>
	<div class="control-group">
...
<script type="text/javascript">
	$(function(){
		$("#date").datepicker({ autoclose: true, todayHighlight: true,dateFormat: 'yy-mm-dd' });
	});
</script>