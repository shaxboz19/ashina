...
<div class="tabbable">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane  <?= ($i == 1) ? 'active' : '' ?>" id="tab<?= $i ?>">
            ...
            <div class="control-group">
                <label class="control-label" for="focusedInput">Прием граждан</label>
                <div class="controls">
                    <input name="content_1[<?= $key ?>]" class="input-xlarge focused" type="text" value="<?= set_value('content_1[' . $key . ']', _t(@$post->content_1, $key)) ?>">
                </div>
            </div>

            <div class="control-group">
                <label class="control-label" for="focusedInput">Национальность</label>
                <div class="controls">
                    <input name="content_2[<?= $key ?>]" class="input-xlarge focused" type="text" value="<?= set_value('content_2[' . $key . ']', _t(@$post->content_2, $key)) ?>">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="content_3[<?= $key ?>]" class="input-xlarge focused" type="text" value="<?= set_value('content_3[' . $key . ']', _t(@$post->content_3, $key)) ?>">
                </div>
            </div>
...
<div class="control-group">
    <label class="control-label" for="focusedInput">Эл-адрес</label>
    <div class="controls">
...
<div class="control-group">
    <label class="control-label" for="focusedInput">Год рождения</label>
    <div class="controls">
        <input id="value_4" name="value_4" class="span3" type="text" value="<?= set_value('value_4', $post->value_4) ?>">
    </div>
</div>
