            ...
            <? $i=1; foreach ($settings['languages']->value as $key => $val): ?>
                <div class="tab-pane  <?=($i==1) ? 'active' : ''?>" id="tab<?=$i?>">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="focusedInput"><?//=lang('title')?> Название</label>
                        <div class="controls">
...
<div class="control-group">
	...
	*/
	...
	<div class="control-group">
		<label class="control-label" for="focusedInput">Координаты lat</label>
		<div class="controls">
			<input id="value_1" name="value_1" class="span3" type="text" value="<?=set_value('value_1', $post->value_1)?>">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label" for="focusedInput">Координаты lng</label>
		<div class="controls">
