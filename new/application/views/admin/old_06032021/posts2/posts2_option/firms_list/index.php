<h2>Список действующих адвокатских бюро, коллегий, фирм и адвокатов (<?=_t(getRegionInfo($category_id, 'title'))?>)
...
<a href="<?//=site_url("admin/posts2_option/index/$category_group/$category_id/region")?><?=site_url('admin/posts2/regions/firms_list')?>">Назад</a>
<?php 
/*
