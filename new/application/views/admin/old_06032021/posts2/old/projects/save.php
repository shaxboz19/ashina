        ...
        foreach ($settings['languages']->value as $key => $val) : ?>
            <div class="tab-pane  <?= ($i == 1) ? 'active' : '' ?>" id="tab<?= $i ?>">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="title" name="title[<?= $key ?>]" class="titles input-xlarge focused titles" type="text" value="<?= set_value('title[' . $key . ']', _t(@$post->title, $key)) ?>">
                    </div>
                </div>
                 <div class="control-group">
...
?>
<div class="control-group">
    <label class="control-label" for="focusedInput">Дата начала:</label>
    <div class="controls">
...
<div class="control-group">
    ...
    <div class="controls">
        <input id="date1" name="date1" class="input-xlarge focused" type="text" value="<?= set_value('date1', to_date("d.m.Y", $post->date1)) ?>">
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <input id="alias" name="alias" class="span3 validate[required,ajax[check_alias2]]" type="text" value="<?= set_value('alias', @$post->alias) ?>">
    </div>
</div>
<div class="control-group">
