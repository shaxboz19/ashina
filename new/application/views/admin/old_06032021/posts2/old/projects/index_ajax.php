      ...
      <tbody>
        <? foreach ($posts as $post) : ?>
          ...
          <tr id="item-<?= $post->id ?>">
            ...
            <td><a href="<?= site_url('admin/group2/index/projects_cat/'.$post->id) ?>" class="btn btn-small btn-info"><i class="icon-list icon-white"></i> Опции</a></td>
            ...
            <td>
              <div class="btn-group">
                <?php if (isset($_GET['page'])) {
                    $page = $_GET['page'];
                    ?>
                  <a href="<?= site_url("admin/posts2/save/{$sel}/$post->id/$page") ?>" class="btn btn-small btn-info"><i class="icon-edit icon-white"></i> Ред-ть</a>
                  
                <?php } else { ?>
                  <a href="<?= site_url("admin/posts2/save/{$sel}/$post->id") ?>" class="btn btn-small btn-info"><i class="icon-edit icon-white"></i> Ред-ть</a>
                <?php } ?>
              </div>
            </td>
