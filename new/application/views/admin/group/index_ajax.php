    ...
    <tbody >
      <? foreach($posts as $post): ?>        
        ...
        if($sel == 'specialties') {?>
              <td style="text-align: center">
                <div class="btn-group">
                    <a href="<?=site_url('admin/group/index/specialists/'.$post->id)?>" class="btn btn-small btn-info"> Врачи</a>
                </div>
            </td>    
                        <?php }?>
            ...
            $page = $_GET['page'];            
        ?>  	
                <a href="<?=site_url("admin/group/save/$category_group/$category_id/$post->id/$page")?>" class="btn btn-small btn-info"><i class="icon-edit icon-white"></i> Ред-ть</a>
                
                <?php } else {?>
           <a href="<?=site_url("admin/group/save/$category_group/$category_id/$post->id")?>" class="btn btn-small btn-info"><i class="icon-edit icon-white"></i> Ред-ть</a>
        <?php }?>
              </div>
            </td>
            <!-- <td>
...
<script>
 ...
 function updateIndex(){
    ...
    $.ajax({
        <?php if(@$_GET['sort']){?>
    url: '<?=base_url()?>'+'admin/group/index_ajax/<?=$category_group?>/<?=$category_id;?>/?sort=<?=@$_GET['sort']?>',
    <?php } else {?>
      url: '<?=base_url()?>'+'admin/group/index_ajax/<?=$category_group?>/<?=$category_id;?>/',
    <?php }?>
  type: "POST",
