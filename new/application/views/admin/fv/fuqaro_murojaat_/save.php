...
<?=form_open_multipart($form_url, array('class'=>'form-horizontal my_form'))?>
                ...
                <div class="row-form">
                    <div class="span3">
                        <?php echo $this->lang->line('ru_middle'); ?>
                    </div>
                    <div class="span9">
                        <input type="text" value="<?php
                        if (isset($fuqaro_murojaat_edit[0]['middle_name']))
                            echo $fuqaro_murojaat_edit[0]['middle_name'];
                        ?>" name="middle_name" size="60" />
                        <span></span>
                    </div>
                    <div class="clear"></div>
                </div>
                        ...
                        <p>
                           ...
                           <!-- <a href="#" id="print_all_uz" class="btn btn-success">
                            ...
                            <a href="#" id="print_all_ru" class="btn btn-success">
                                <?php echo $this->lang->line('print_ru'); ?> (Ru)
                            </a>
...
<div style="width: 100%; display: none;" id="for_word">
    <table align="center" style="width: 70%">
        ...
        <td style="margin-right: 10px;display: block;width: 119px;">
                <img src="<?=get_resource_url()?>images/logo_form.png" style="margin-right: 10px;"  alt=""/>
            </td>
            <td>
                <h2 style="float:left;width: 50%;">
                O'zbekiston Respublikasi Tashqi savdo Vazirining virtual qabulxonasi</h2>              
            </td>
        </tr>
    </table>
    <br /><br />
...
<div style="width: 100%; display: none;" id="for_word1">
    <table align="center" style="width: 70%">
        ...
        <td style="margin-right: 10px;display: block;width: 119px;">
            ...
            <td>
                <h2 style="float:left;width: 50%;">
                Виртуальная приемная Министра внешней торговли Республики Узбекистан</h2>
...
<div style="width: 100%; display: none;" id="print_uz">
    <div style="text-align: center;margin-bottom: 20px;">
            <img src="<?=get_resource_url()?>images/logo_form.png"  alt=""/>
            <h2>O'zbekiston Respublikasi Tashqi savdo Vazirining virtual qabulxonasi</h2>           
    </div>
